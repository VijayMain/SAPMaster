...
@WebServlet("/Import_BulkMaterialsControl")
public class Import_BulkMaterialsControl extends HttpServlet {
				...
				try {
					...
					while (it.hasNext()) {
						...
						if (fileItemTemp.isFormField()) {
							...
							if (fieldName.equalsIgnoreCase("uploadfor")) {
					...
					dao.attachBulkMaterial_File(response, bean, session);
					}
				} catch (Exception e) {
					e.printStackTrace();
				}
