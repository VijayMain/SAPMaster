...
<script language="javascript">
	...
	function CheckMasterValidation() {
		...
		confirm("You are about to change Basic Details");			
			var xmlhttp;
			...
			xmlhttp.open("POST", "GetMasterEdit_Data.jsp?q=" + str +"&p=" + typeMat +"&r=" + userId +"&plant=" + plant, true);
			xmlhttp.send();
	};
...
String masterLogin="";
int s_no=1;
PreparedStatement ps_check = null, ps_upload = null,ps_check2=null,ps_mst=null;
ResultSet rs_check = null, rs_upload = null,rs_check2=null,rs_mst=null;
  PreparedStatement	ps_check1 = con.prepareStatement("SELECT  * FROM user_rel where old_id="+ userId);
	...
	if (rs_check1.next()) {
		...
		if(rs_check1.getString("type_acct").equalsIgnoreCase("PUR_MSTCHECK")){
		pur_id=rs_check1.getInt("old_id");
		}
	}
%>
<form action="NewMaster_CreationControl" method="post" name="approve" id="approve" onsubmit="return ValidationForm();">
<input type="hidden" name="editedData" id="editedData" value="1"/>
<input type="hidden" name="pur_id" id="pur_id" value="<%=pur_id%>"/>
<%
ps_check = con.prepareStatement("select * from sap_mastertran where id="+hid);
 ...
 <tr style="font-size: 12px; background-color: #acc8cc; font-weight: bold;">
		...
		<strong style="font-family: Arial; font-size: 16px; color: #10006E;">&nbsp;&nbsp;Material Master Creation for </strong>
			<select name="typeMat" id="typeMat"  onchange="CheckMasterValidation()"> 
					    <%
						ps_mst = con.prepareStatement("select * from importfor where enable=1 and code='"+rs_check.getString("material_type")+"' union all select * from importfor where enable=1 and code!='"+rs_check.getString("material_type")+"'");
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='plant'  and plant='"+rs_check.getString("plant")+
						"' union all select * from master_data where tablekey='plant'  and plant!='"+rs_check.getString("plant")+"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>					
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("code")%> <%=rs_mst.getString("descr")%></option>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='sales_org'  and plant='"+rs_check.getString("plant")+"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("code")%> <%=rs_mst.getString("descr")%></option>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='dist_channel' and plant='"+rs_check.getString("plant")+"' and code='" + rs_check.getString("dist_channel") + "' union all select * from master_data where tablekey='dist_channel' and plant='"+rs_check.getString("plant")+"' and code!='" + rs_check.getString("dist_channel") +"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){							
						%>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='profitCenter'  and plant='"+rs_check.getString("plant")+"' and code ='" +rs_check.getString("profitCenter")+"' union all select * from master_data where tablekey='profitCenter'  and plant='"+rs_check.getString("plant")+"' and code !='" +rs_check.getString("profitCenter") + "'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("code")%> <%=rs_mst.getString("descr")%></option>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='mrp_Controller'  and plant='"+rs_check.getString("plant")+"' and code='" + rs_check.getString("mrp_Controller")+"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("plant")%> <%=rs_mst.getString("descr")%></option>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='storage_loc'  and plant='"+rs_check.getString("plant")+"' and code='"+rs_check.getString("prod_StorageLoc")+"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("code")%> <%=rs_mst.getString("descr")%></option>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='prod_supervisor'  and plant='"+rs_check.getString("plant")+"' and code='"+rs_check.getString("prod_supervisor")+"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("plant")%> <%=rs_mst.getString("descr")%></option>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='prod_schedProfile'  and plant='"+rs_check.getString("plant")+"' and code='" + rs_check.getString("prod_schedProfile")+"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("plant")%> <%=rs_mst.getString("descr")%></option>
						...
						<%
						ps_mst = con.prepareStatement("select * from master_data where tablekey='valueation_class' and plant ='"+rs_check.getString("material_type")+"' and code='" +rs_check.getString("valueation_class") +"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						%>
						<option value="<%=rs_mst.getString("code")%>"><%=rs_mst.getString("code")%> <%=rs_mst.getString("descr")%></option>
						...
						%>
							...
							<tr>
								...
								<input type="submit" name="Submit" id="Submit" value="SAVE / UPDATE" class="button" style="height: 27px;font-weight: bold;"/>
...
%>
 ...
 <tr style="font-size: 12px; background-color: #acc8cc; font-weight: bold;">
		<td colspan="4">
		<strong style="font-family: Arial; font-size: 16px; color: #10006E;">&nbsp;&nbsp;Material Master Creation for </strong>
			<select name="typeMat" id="typeMat"> 
					    <%
						ps_mst = con.prepareStatement("select * from importfor where enable=1 and code='"+rs_check.getString("material_type")+"' union all select * from importfor where enable=1 and code!='"+rs_check.getString("material_type")+"'");
						rs_mst = ps_mst.executeQuery();
						while(rs_mst.next()){
						...
						%>
							...
							<%
							int cnt=0;							
							System.out.println("Stage = " + rs_check.getString("stage").equalsIgnoreCase("1"));
...
<a href="http://www.muthag<th><%= rs_check.getString(".com/"><strong>Mutha Group of Foundries</strong> </a> &nbsp; | &nbsp; 
