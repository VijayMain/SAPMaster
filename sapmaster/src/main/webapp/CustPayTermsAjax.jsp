...
try{
	...
	ps_mst = con.prepareStatement("SELECT  *  FROM master_data where tablekey='BP_Group' and enable=1 and descr like '"+custCode+"%'");
	rs_mst = ps_mst.executeQuery();
	while(rs_mst.next()){
		mst_data = rs_mst.getString("code");		
		ps_mst1 = con.prepareStatement("SELECT  *  FROM  vendcust_upRel where Cust_ReconACC !='' and BP_Group='"+mst_data+"'");
